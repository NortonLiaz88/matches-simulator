package com.norton.soccernews.ui.adapter;
...
import com.norton.soccernews.databinding.MatchItemBinding;
import com.norton.soccernews.domain.Match;
import com.norton.soccernews.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            intent.putExtra(DetailActivity.Extras, match);
